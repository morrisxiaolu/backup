...
/*
 * Copyright (c) 2001-2002,2005,2008 Wind River Systems, Inc.
 *
...
--------------------
01e,28mar08,jmt  Defect 119033- Fix Apigen errors.
01d,17nov05,jmt  SPR 115097: Fix IDE_CONFIG define
...
#define IDE_TIMING1		V_IO_ALE_TO_WRITE(4) | \
                                ...
                                V_IO_CS_TO_OE(3) | \
                                V_IO_OE_TO_CS(2)
#define SWARM_IDE_CONFIG	V_IO_WIDTH_SEL(K_IO_WIDTH_SEL_2) | \
                                M_IO_RDY_ACTIVE | \
                                M_IO_ENA_RDY
