/* sb1.h - Bcm1250 platform header */

/* Copyright 2001-2008 Wind River Systems, Inc. */
...
--------------------
01m,01oct08,pgh  Fix clock rate difference between default rate and target
                 board.
01l,26apr07,slk  make adding PCI code based on INCLUDE_PCI
01l,01mar07,rlg  update from new code drop from BroadCom
01k,13apr06,pes  Support boot-time detection of CPU_CLOCK_RATE.
01j,15mar06,pes  Add BCM1480 support.
 ...
 * SB1 User's Manual (UM) contains full descriptions of
 * the following register uses.
 *
 * Note: in new code, definitions from ./sb1_*.h
 ...
 */
#define SB1_SR (SR_CU1 | SR_CU0 | SR_FR | SR_IMASK0 | SR_IE | SR_KX)
...
/*
 * The SB1 interrupt system distinguishes 64 system interrupt sources
...
/* interrupt vectors */
#define IV_INT0_VEC		60	/* sb1 INT 0 */
#define IV_INT1_VEC		61	/* sb1 INT 1 */
#define IV_INT2_VEC		62	/* sb1 INT 2 */
#define IV_INT3_VEC		63	/* sb1 INT 3 */
#define IV_INT4_VEC		64	/* sb1 INT 4 */
#define IV_INT5_VEC		65	/* sb1 INT 5 */

/* sb1 interrupt level indexes */
#define ILVL_SB1_WATCHDOG0   0
#define ILVL_SB1_WATCHDOG1   1

#define ILVL_SB1_SMB0        6
#define ILVL_SB1_SMB1        7
#define ILVL_SB1_UART0       8
#define ILVL_SB1_UART1       9

#define ILVL_SB1_MAC0        19
#define ILVL_SB1_MAC1        20
#define ILVL_SB1_MAC2        21

#define ILVL_SB1_MBOX_INT_0	26
#define ILVL_SB1_MBOX_INT_1	27
#define ILVL_SB1_MBOX_INT_2	28
#define ILVL_SB1_MBOX_INT_3	29

#define ILVL_SB1_PCI_INTA    56
#define ILVL_SB1_PCI_INTB    57
#define ILVL_SB1_PCI_INTC    58
#define ILVL_SB1_PCI_INTD    59
 ...
 * See UM, Figure 8-2.
 */
#if BCM_FAMILY && (BCM_FAMILY == BCM_SB1)
...
#define PCI_CONF_ADRS     0xDE000000	    /* PCI config space, match byte lane */
...
#elif BCM_FAMILY && (BCM_FAMILY == BCM_SB1A)
#define PCI_MEM_ADRS      0x31000000
#define PCI_MEM_SIZE      0x0F000000
#define PCI_IO_ADRS       0x2C000000
#define PCI_ISA_IO_SIZE   0x00008000
#define PCI_IO_SIZE       0x02000000

#define PCI_CONF_ADRS     0x2E000000
#define PCI_CONF_SIZE     0x01000000

/* Add the following to the above for "match bit lane" mode */
#define BIT_ENDIAN_OFFSET 0x80000000

#else /* BCM_FAMILY == BCM_SB1A */
#error "Unknown BCM_FAMILY"
#endif /* BCM_FAMILY && (BCM_FAMILY == BCM_SB1) */

#define PCI_LAT_TIMER     255

/*
 * These are dummy definitions for PCI access mechanisms 1 and 2.
 * SB1 accesses use mechanism 0 only.  Thus the following should
...
#define PCI_IRQ_LINES (ILVL_SB1_PCI_INTD - ILVL_SB1_PCI_INTA + 1)
#define INT_NUM_IRQ0  (ILVL_SB1_PCI_INTA)
...
#define PCI_INT_HANDLER_BIND(vector, routine, param, pResult)          \
    {                                                                  \
    IMPORT STATUS sb1IntConnect(int, int, VOIDFUNCPTR, int);        \
    IMPORT STATUS sb1IntEnable(int);                                \
    *pResult = sb1IntConnect ( IVEC_TO_INUM(vector), IV_INT0_VEC,   \
                                  (VOIDFUNCPTR)(routine),              \
                                  (int)(param) );                      \
    if (*pResult == OK)                                                \
        *pResult = sb1IntEnable( IVEC_TO_INUM(vector));             \
    }
#endif /* INCLUDE_PCI */
