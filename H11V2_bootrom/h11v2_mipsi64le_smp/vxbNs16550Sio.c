...
/*
 * Copyright (c) 1984-2008 Wind River Systems, Inc. All rights are reserved.
 *
...
#define VXB_NS16550_CONSOLE_BAUD_RATE	115200   /* mxl 9600 -> 115200 */
...
#define X_REG_GET REG_GET
#define X_REG_SET REG_SET
