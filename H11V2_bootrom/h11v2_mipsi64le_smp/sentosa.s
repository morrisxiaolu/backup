...
board_earlyinit:
	 ...
	 */
       ...
       /*
        * Also set up UART0 for polled output to monitor the
        * boot progress,
        */
		li	t0,PHYS_TO_K1(A_DUART_CHANREG(0,R_DUART_CLK_SEL))
		li	t1,(BCM1250_DUART_REF_CLK_RATE/ \
                            (BCM1250_UART_DEFAULT_BAUD * 20) - 1)
		sd	t1,0(t0)
		li	t0,PHYS_TO_K1(A_DUART_CHANREG(0,R_DUART_CMD))
		li	t1,0x04
		sd	t1,0(t0)
#endif
