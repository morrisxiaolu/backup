...
--------------------
01z,12jun08,kkz  Updating version number for 6.7 release
01y,23mar06,jb3  Bump Version for Spring 06.
01x,23nov04,mil  Fixed compilation warning. (SPR 103341)
01w,02oct02,nrv  fixing diab build error
...
#ifdef INCLUDE_MTD_S29GL512N
extern FLStatus  s29glMTDIdentify (FLFlash vol);
#endif /* INCLUDE_MTD_USR */
