...
--------------------
01g,29aug07,mze  re-added SOURCE_ONLY option to fix GNU compiler issue
...
01d,10aug07,mze  added FOLDER_DSHM
01c,02jul07,bwa  added bsp-specific value for DSHM TIPC parameters
01b,23jun07,bwa  updated to split of debug and core components.
...
Component INCLUDE_DSHM_BUS_CTLR_SIBYTE {
    NAME        DSHM virtual bus controller for sibyte BSPs
    SYNOPSIS    Instance of the virtual bus controller on parent bus
    MODULES     dshmBusCtlrSibyte.o
    PROTOTYPE   void dshmBusCtlrSibyteRegister (void);
    INIT_RTN    dshmBusCtlrSibyteRegister ();
...
Component INCLUDE_DSHM_VXSIBYTE {
    NAME        Sibyte - Peer driver
    SYNOPSIS    Peer-to-peer driver for Sibyte-derived BSPs
    MODULES     dshmPeerVxSibyte.o
    PROTOTYPE   void dshmPeerVxSibyteLoad (void);
    INIT_RTN    dshmPeerVxSibyteLoad ();
...
InitGroup usrDshmInit {
    ...
    INIT_ORDER  \
                ...
                INCLUDE_DSHM_ADAPT \
                INCLUDE_DSHM_BUS \
                INCLUDE_DSHM_BUS_CTLR_SIBYTE \
                INCLUDE_DSHM_VXSIBYTE
}
