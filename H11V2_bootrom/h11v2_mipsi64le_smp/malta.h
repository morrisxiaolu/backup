...
/* Copyright (c) 2000-2005,2006,2008 Wind River Systems, Inc. */
...
--------------------
01v,27aug08,jmt  Update for ATA support
01u,14mar06,pes  Add support for CoreFPGA3 (SOC-it based).
01t,29nov05,agf  add define for init of CONFIG0 reg
01s,30aug05,pes  SPR #111248: Remove defines to override default 8259 PIC
		 driver functions
01r,26apr05,d_c  Add defines for MMU size field in CFG1
01q,02mar05,pes  Correct copyright notation
01p,15feb05,pes  Add define values for the MALTA_REVISION register. Cleanup
                 system controller-related conditional compilation.
01o,07oct04,pes  Apigen cleanup
01n,04oct04,pes  Redefined PCI_AUTOCONFIG_FLAG and PCI_AUTOCONFIG_FLAG_ADDR
                 to always use a kseg0 address instead of floating with
		 LOCAL_MEM_LOCAL_ADRS. This helps prevent unintended accesses
		 to mapped space if sysLib.c is compiled for a mapped kernel
		 but linked into an unmapped one.
01m,20sep04,pes  Define _WRS_SYS_INT_INIT_PIC_NOT_USED and
                 _WRS_SYS_INT_EOI_NOT_USED to silence warnings.
01l,28may03,jmt  Add 20kc changes
...
/*#define BUS			BUS_TYPE_PCI*/	/* no off-board bus interface, comment by wangzx to avoid warning*/

#undef	INCLUDE_EGL	/* configAll.h defines this for MIPS */

/* override default value of 32 pci devices */
#define PCI_MAX_DEV		22 /* last device number on bus 0  */


/* Initial CoProcessor Register Values */
#define INITIAL_CFG             3  /* 3 = cached */
/*#define INITIAL_SR              (SR_CU0 | SR_BEV)*/  /*comment by wangzx to avoid warning*/
...
#define LOONGSON_PCIMEM0_BASE     0x14000000  /* yinwx 20100121*/
#define LOONGSON_PCIMEM0_SIZE     0x04000000  /* 64MB yinwx 20100121*/
#define LOONGSON_PCIIO16_BASE     0x00004000  /* PCI 0 I/O:  yinwx 20100121 */
#define LOONGSON_PCIIO16_SIZE     0x00010000  /* 64K     yinwx 20100121 */
#define LOONGSON_PCIIO0_BASE      0x1fd00000  /* added by yinwx, 20100121 */

#define MALTA_PCIMEM0_BASE        0x08000000  /* PCI 0 memory:        */
#define MALTA_PCIMEM0_SIZE        0x08000000  /*   128 MByte          */
#define MALTA_PCIIO0_BASE         0x10000000  /* PCI 0 I/O:           */
#define MALTA_PCIIO0_SIZE         0x04000000  /*   64 MByte           */
#define MALTA_CORECTRL_BASE       0x1fe80000  /* modified by yinwx */
...
#define MALTA_FPGA_SIZE2N	  0x01000000  /*    16 MByte (2^n)    */

#define MALTA_CBUS_UART           0x1F000900  /* CBUS UART:           */
#define MALTA_CBUS_UART_REG_DELTA 8           /* UART regs seperation */
#define MALTA_CBUS_BAUD_CLK_FREQ  3686400     /* 3.6864 Mhz */
...
#define MALTA_CONFIG1_MM_SHF		25
#define MALTA_CONFIG1_MM_MSK		(MSK(6) << MALTA_CONFIG1_MM_SHF)
...
#define MALTA_IDSEL_CORECARD		27
...
/*#define IDE_CONFIG		0x0	*//* 1: uses ideTypes table ,comment by wangzx to avoid warning*/
#define IDE_INT_LVL             0x0e

/* hard disk (ATA) */

#define ATA0_IO_START0		(MALTA_PCI0_IO_BASE + 0x1f0)	/* io for ATA0 */
#define ATA0_IO_STOP0		(MALTA_PCI0_IO_BASE + 0x1f7)
#define ATA0_IO_START1		(MALTA_PCI0_IO_BASE + 0x3f6)
#define ATA0_IO_STOP1		(MALTA_PCI0_IO_BASE + 0x3f7)
...
#define ATA1_IO_START0		(MALTA_PCI0_IO_BASE + 0x170)	/* io for ATA1 */
#define ATA1_IO_STOP0		(MALTA_PCI0_IO_BASE + 0x177)
#define ATA1_IO_START1		(MALTA_PCI0_IO_BASE + 0x376)
#define ATA1_IO_STOP1		(MALTA_PCI0_IO_BASE + 0x377)
...
/*#define INT_NUM_IRQ0		(INT_VEC_BASE + 0x06)*/ /* base of 8259 interrupts comment by wangzx to avoid warning*/
...
#define PCI_AUTOCONFIG_FLAG        ( *(UCHAR *)(K0BASE + \
				     PCI_AUTOCONFIG_FLAG_OFFSET) )
#define PCI_AUTOCONFIG_FLAG_ADDR (K0BASE + \
				     PCI_AUTOCONFIG_FLAG_OFFSET)
