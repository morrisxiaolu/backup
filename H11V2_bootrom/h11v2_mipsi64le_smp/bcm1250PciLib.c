...
#define HUGE_LOOP for(loop=300000000;loop>0;loop--);
...
/******************************************************************************
*
* sysPciAutoconfigPreProbeBridgeInit - required initialization for a secondary
*
...
/******************************************************************************
*
* sysPciAutoconfigPostProbeBridgeInit - do finalization for a secondary bus
*
* This routine is called by the probe logic just after scanning a
* secondary bus.  It does the required fabric or bridge finalization for a 
* secondary bus. Always a no-op.
*
* RETURNS: N/A
* 
* ERRNO
...
/******************************************************************************
*
* sysPciAutoconfigPreEnumBridgeInit - initialization before enum of secondary.
*
* This routine is called by the enumeration (assignment) logic just
* before scanning the secondary bus of a bridge. It does any required
* initialization before enumerating a secondary bus. Always a no-op.
*
* RETURNS: N/A
* 
* ERRNO
...
/******************************************************************************
*
* sysPciAutoconfigPostEnumBridgeInit - finalization after enum of secondary
*
* This routine is called by the enumeration (assignment) logic just
* after scanning the secondary bus of a bridge.  It does any required
* finalization after enumerating a secondary bus. For an 
...
/******************************************************************************
*
* ldtSecondaryInit - reset and initialize the secondary
*
*
*
* This routine is the Top level control of bridge secondary and fabric 
* initialization for LDT. It resets and then initializes the secondary of 
* a bridge to LDT (currently only the BCM1250 host bridge).
*
* RETURNS: N/A
* 
* ERRNO
