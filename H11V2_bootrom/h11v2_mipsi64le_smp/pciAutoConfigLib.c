...
--------------------
01t,01mar07,rlg  defect 88243  compiler warning cleanup
01t,25oct06,pes  Resolve compiler warning about 'bus' being used before set.
...
LOCAL void pciAutoBusConfig
    ...
    {
    UCHAR bus = 0xff;          /* Bus number for current bus */
    UINT dev_vend;
    UINT32 debugTmp;
    UINT32 debugTmp2;
    UINT32 debugTmp3;
