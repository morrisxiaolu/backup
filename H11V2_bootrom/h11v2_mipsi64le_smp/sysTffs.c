...
#define INCLUDE_MTD_S29GL512N
#define INCLUDE_TL_FTL                  /* FTL translation layer */
#undef  INCLUDE_TL_SSFDC                /* SSFDC translation layer */
#undef INCLUDE_SOCKET_SIMM             /* SIMM socket interface */   // mxl del : don't know what's for?
...
#undef INCLUDE_TFFS_BOOT_IMAGE		/* include tffsBootImagePut() mxl: ²»×÷Îªbootrom */
...
#ifndef DOC
#include "tffsConfig.c"    /* mxl:¡¡old: "tffs/tffsConfig.c"   */
#endif /* DOC */
...
#if 1    /* FALSE mxl: need to modified */
/*******************************************************************************
*
...
STATUS sysTffsFormat (void)
	...
	{
/* mxl del:  #define	HALF_FORMAT	 */ /* lower 0.5MB for bootimage, upper 1.5MB for TFFS */
#ifdef	HALF_FORMAT
