...
#define i10cacheop(kva, n, cacheSize, cacheLineSize, op) \
	...
	.globl GTEXT(cacheLsn2eSync)		/* cache sync operation (k0->k1) */
	.globl GTEXT(cacheLsn2eSync2)		/* cache k1->k0 operation*/
...
/******************************************************************************
*
* cacheLsn2eSync2 - sync region of memory through all caches
*
* RETURNS: N/A
*
* void cacheLsn2eSync2 (void *vAddr, UINT pageSize);
*/
	.ent	cacheLsn2eSync2
FUNC_LABEL(cacheLsn2eSync2)
	/* Save parameters */
	move	t0,a0			/* beginning VA */
	move	t1,a1			/* length */
